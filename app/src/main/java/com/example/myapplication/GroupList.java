        ...
        public class Searchroom extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    ArrayAdapter arrayAdapter = new ArrayAdapter(GroupList.this, android.R.layout.simple_list_item_1, tablelist);
                    listView.setAdapter(arrayAdapter);

                    listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            Intent intent = new Intent(GroupList.this, Group.class);
